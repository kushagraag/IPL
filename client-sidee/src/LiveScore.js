          ...
          <div className="row" style={{ 
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center" style={{ backgroundColor: '' }}>
              <div className="d-flex flex-column align-items-center">
                <img src="https://img1.hscicdn.com/image/upload/f_auto,t_ds_square_w_160,q_50/lsci/db/PICTURES/CMS/313400/313418.logo.png" alt={match.team1} style={{ width: '50%' }} />
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center" style={{ backgroundColor: '' }}>
              <div className="d-flex flex-column align-items-center">
                <img src="https://img1.hscicdn.com/image/upload/f_auto,t_ds_square_w_160,q_50/lsci/db/PICTURES/CMS/313400/313423.logo.png" alt={match.team2} style={{ width: '50%' }} />
